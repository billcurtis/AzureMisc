...
try {
    ...
    if (-not $hostPool) {
        ...
        $hostPoolParams = @{
            ...
            CustomRdpProperty     = "enablerdsaadauth:i:1;redirectclipboard:i:1;audiocapturemode:i:1;audiomode:i:0;camerastoredirect:s:*;devicestoredirect:s:*;drivestoredirect:s:;redirectcomports:i:0;redirectprinters:i:0;redirectsmartcards:i:1;use multimon:i:0;desktopwidth:i:1920;desktopheight:i:1080;smart sizing:i:1;"
            ErrorAction           = "Stop"
        }
